...
async function seedProblems() {
    try {
        // Create a default admin user first (you'll need to create one through the API)
        const adminId = "60d0fe4f5311236168a109ca"; // This should be replaced with actual admin ID
...
// Function to seed problems without admin requirement
async function seedProblemsWithoutAdmin() {
    try {
        // Clear existing problems
        await Problem.deleteMany({});
        console.log('Cleared existing problems');
